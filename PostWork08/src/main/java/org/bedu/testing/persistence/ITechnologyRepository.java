...
public interface ITechnologyRepository extends JpaRepository<TechnologyEntity , Long> {
    ...
    List<TechnologyEntity> findByNameContainingIgnoreCaseOrDescriptionContainingIgnoreCaseOrSlugContainingIgnoreCase(String name, String description, String slug);
