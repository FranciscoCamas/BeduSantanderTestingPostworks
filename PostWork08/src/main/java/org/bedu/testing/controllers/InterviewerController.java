...
public class InterviewerController {
    ...
    public ResponseEntity<InterviewerDTO> getinterviewer(@PathVariable Long interviewerId){
        ...
        if (interviewerDb.isEmpty())
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "The request interviewer does not exist.");

        return ResponseEntity.ok(interviewerDb.get());
    }
     ...
     */
    @PostMapping
    public ResponseEntity<InterviewerDTO> createInterviewer(@Valid @RequestBody InterviewerDTO interviewerDTO){
    ...
    public ResponseEntity<Void> updateClient(@PathVariable Long interviewerId, @Valid  @RequestBody InterviewerDTO interviewer){
